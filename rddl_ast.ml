...
let find_component ui page component =
  try
    Some begin
      let page = List.assoc page ui.pages in
      List.assoc component page.components
    end
  with Not_found -> None

let find_container ui page container =
  try
    Some begin
      let page = List.assoc page ui.pages in
      List.assoc container page.containers
    end
  with Not_found -> None
